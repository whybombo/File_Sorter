...
# Default paths (you can customize these)
...
class FileSorterApp:
    def __init__(self, root):
        ...
        # Downloads path label and entry
        ...
        self.downloads_entry.insert(0, downloads_path)  # Set default path
        ...
        # Documents path label and entry
        ...
        self.documents_entry.insert(0, documents_path)  # Set default path
